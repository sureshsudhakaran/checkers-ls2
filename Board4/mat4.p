...
caprearr(B,W,H2,D2,-1):- capgen(B,W,4,H2,D2), H2=[_,_], D2=[P,_], P is 4.
caprearr(B,W,H2,D2,K):- capgen(B,W,4,H2,D2), H2=[X,Y], rmv([[X,Y]],B,[],H1), append(H1,[[]],H3), append([D2],H3,H4), vulnerab(4,W,H4,0,K).
...
vulnerab(4,W,[[X,Y]|B],L,V):- append(B,[[X,Y]],C),!,vulnerab(4,W,C,L,V).


rearr(B,W,H2,D2,-1):- gen(B,W,4,H2,D2), H2=[_,_], D2=[P,_], P is 4.
rearr(B,W,H2,D2,K):- gen(B,W,4,H2,D2), H2=[X,Y], rmv([[X,Y]],B,[],H1), append(H1,[[]],H3), append([D2],H3,H4), vulnerab(4,W,H4,0,K).
